...
\begin{marginfigure}[1.25in]
    ...
    control and an optional unidirectional parallel ankle spring to offset the
    required angle torque.}\label{fig:prosthesis_render_annotated}
\end{marginfigure}
...
\begin{table*}
    ...
    ankle torque is $\unit[290]{N \cdot m}$ if the optional unidirectional
    springs are used. This torque is achieved at $10^\circ$ of
