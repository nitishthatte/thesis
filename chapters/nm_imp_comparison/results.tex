...
\begin{marginfigure}
    ...
    \caption{Fraction of steps for which impedance control sucessfully
    transitions through all three stance phases. Intrduction of gait
