...
In \cref{sec:nm_vs_imp_phase_imp} we present our attempt to implement this style
of control on our robotic prosthesis. We found that the variability from step to
step alone was enough to cause significant drift in the thigh angle. Thus we
were not able to achieve a consistent gait with this control scheme.
