...
lambda_pese = np.linspace(0, 2, 100)    #normalized fiver length

fl_pese = ((lambda_pese - 1)**2) * (lambda_pese > 1)
...
p0, = ax.plot(lambda_pese, fl_pese, linewidth=2, color=color2)

ax.set_title('PE/SE Force-Length', y=1.08)
...
ax.set_xticklabels(['0', r'$\mathsf{l_{ref}}$', r'$\mathsf{\epsilon_{ref}}$'])
