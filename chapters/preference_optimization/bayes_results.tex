...
(LH)\sidenote[][1.75in]{LH sampling divides the parameter space into ${(2N)}^D$
...
perhaps due to $M=12$ samples of $x_m^*$ being insufficient and the difficulty
of accurately sampling $x_m^*$ in higher dimensions.
